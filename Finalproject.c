    ...
    do{
        ...
        switch(pil){
            case 1:
                ...
                break;
            case 2:
            	billTiket(pil_F, pil_B, pil_J, pil_K);
                break;
            case 3:
                exit(0);
            default:
...
void billTiket(int Film, int Bioskop, int Jam, int Kursi){
    ...
    printf("Masukan Jumlah Uang: Rp. "); scanf("%llu" , &bayar);
    kembalian = bayar - 40000;
    kembalian <= 0 ? printf("Terima Kasih Telah berbelanja!\n\n") : printf("Kembalian anda lagi Rp. %llu \n\n" , kembalian);
}
